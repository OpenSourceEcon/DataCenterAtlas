...
data_dir = os.path.join(proj_dir, "data", "UT")
rates_path = os.path.join(data_dir, "rates_ut_2025.csv")

# %%
# I used ChatGPT to read the PDF of the Utah State Tax Commission, Property Tax
# Division, "2025 Tax Rates by Tax Area" document to create the
# rates_ut_2025.csv document.
# "https://files.tax.utah.gov/propertytax/tax-rates/area-rates/" +
# "taxarearates2025.pdf"
