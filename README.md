...
This repository contains the data, code, and images for DataCenterAtlas.org revenue map and equivalences in energy use, water use, and employment.

## How to run the code for these analyses on your local computer
Put instructions here for replicating the analyses.
